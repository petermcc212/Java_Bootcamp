public class SearchTree implements  NodeList {
    ...
    public boolean addItem(ListItem newItem) {
        if(this.root == null) {
            // the tree was empty, so our list becomes the head of the tree
            this.root = newItem;
            return true;
        }
            ...
            while(currentItem != null) {
                ...
                if (comparison < 0) {
                    ...
                    if (currentItem.previous() != null) {
                        ...
                        // there's no node to to the left, so add at this point
    ...
    public boolean removeItem(ListItem item) {
        ...
        while(currentItem != null){
            ...
            if(comparison < 0){
                ...
                // equal: we've found the item so need to remove it
